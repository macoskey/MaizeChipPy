int forkModeDataClient(struct FPGAvars *FPGA, struct ENETcommVar *enetComms, struct INITvars *initVars, struct SETUPvars *setupVars, int *chld2prnt_pipe, int *prnt2chld_pipe){
	int thisRunMode = 0;
